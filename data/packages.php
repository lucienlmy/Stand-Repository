...
$packages = [
	"lua/natives-3407a" => [
		...
		"version" => "r2",
		"files" => [
			"lib/natives-3407a/init.lua" => "stand.sh/dl/lua/lib/natives-3407a/init.source.lua",
			//"lib/natives-3407a/init.source.lua" => "stand.sh/dl/lua/lib/natives-3407a/init.source.lua",
			"lib/natives-3407a/g.lua" => "stand.sh/dl/lua/lib/natives-3407a/g.source.lua",
	...
	"lua/natives-3274a" => [
		...
		"version" => "r2",
		"files" => [
			"lib/natives-3274a/init.lua" => "stand.sh/dl/lua/lib/natives-3274a/init.source.lua",
			//"lib/natives-3274a/init.source.lua" => "stand.sh/dl/lua/lib/natives-3274a/init.source.lua",
			"lib/natives-3274a/g.lua" => "stand.sh/dl/lua/lib/natives-3274a/g.source.lua",
	...
	"lua/natives-3095a" => [
		...
		"version" => "r2",
		"files" => [
			"lib/natives-3095a/init.lua" => "stand.sh/dl/lua/lib/natives-3095a/init.source.lua",
			//"lib/natives-3095a/init.source.lua" => "stand.sh/dl/lua/lib/natives-3095a/init.source.lua",
			"lib/natives-3095a/g.lua" => "stand.sh/dl/lua/lib/natives-3095a/g.source.lua",
	...
	"lua/natives-2944b" => [
		...
		"version" => "r2",
		"files" => [
			"lib/natives-2944b/init.lua" => "stand.sh/dl/lua/lib/natives-2944b/init.source.lua",
			//"lib/natives-2944b/init.source.lua" => "stand.sh/dl/lua/lib/natives-2944b/init.source.lua",
			"lib/natives-2944b/g.lua" => "stand.sh/dl/lua/lib/natives-2944b/g.source.lua",
	...
	"lua/natives-2944a" => [
		...
		"version" => "r2",
		"files" => [
			"lib/natives-2944a/init.lua" => "stand.sh/dl/lua/lib/natives-2944a/init.source.lua",
			//"lib/natives-2944a/init.source.lua" => "stand.sh/dl/lua/lib/natives-2944a/init.source.lua",
			"lib/natives-2944a/uno.lua" => "stand.sh/dl/lua/lib/natives-2944a/uno.source.lua",
			//"lib/natives-2944a/uno.source.lua" => "stand.sh/dl/lua/lib/natives-2944a/uno.source.lua",
			"lib/natives-2944a/g.lua" => "stand.sh/dl/lua/lib/natives-2944a/g.source.lua",
			//"lib/natives-2944a/g.source.lua" => "stand.sh/dl/lua/lib/natives-2944a/g.source.lua",
			"lib/natives-2944a/g-uno.lua" => "stand.sh/dl/lua/lib/natives-2944a/g-uno.source.lua",
	...
	"lua/natives-1681379138" => [
		...
		"priority" => 8,
		"files" => [
			"lib/natives-1681379138/init.lua" => "stand.sh/dl/lua/lib/natives-1681379138-r2/init.source.lua",
			//"lib/natives-1681379138/init.source.lua" => "stand.sh/dl/lua/lib/natives-1681379138-r2/init.source.lua",
			"lib/natives-1681379138/uno.lua" => "stand.sh/dl/lua/lib/natives-1681379138-r2/uno.source.lua",
			//"lib/natives-1681379138/uno.source.lua" => "stand.sh/dl/lua/lib/natives-1681379138-r2/uno.source.lua",
			"lib/natives-1681379138/g.lua" => "stand.sh/dl/lua/lib/natives-1681379138-r2/g.source.lua",
			//"lib/natives-1681379138/g.source.lua" => "stand.sh/dl/lua/lib/natives-1681379138-r2/g.source.lua",
			"lib/natives-1681379138/g-uno.lua" => "stand.sh/dl/lua/lib/natives-1681379138-r2/g-uno.source.lua",
	...
	"lua/Example Scripts" => [
		...
		"files" => [
			...
			"Example Scripts/HTTP 1.pluto" => "raw.githubusercontent.com/calamity-inc/Stand-Example-Scripts/cd9c1c9cf6311a0e74c596961323d8d5d0540d0f/HTTP 1.pluto",
			"Example Scripts/HTTP 2.pluto" => "raw.githubusercontent.com/calamity-inc/Stand-Example-Scripts/cd9c1c9cf6311a0e74c596961323d8d5d0540d0f/HTTP 2.pluto",
			...
			"Example Scripts/UI3D.pluto" => "raw.githubusercontent.com/calamity-inc/Stand-Example-Scripts/e4450a7305952fe3ce1674410b9275c4dbece2d6/UI3D.pluto",
	...
	"lua/Heist Control" => [
		...
		"files" => [
			"Heist Control.lua" => "raw.githubusercontent.com/calamity-inc/Stand-Heist-Control/da789986fab4dff6fbf0b2c9ce3cf3b9d7de6c8b/Heist Control.lua",
			...
			"store/Heist Control/Language/French.txt" => "raw.githubusercontent.com/calamity-inc/Stand-Heist-Control/bd267c672b08bfdd940868c270e76f8e3ad66a4b/store/Heist Control/Language/French.txt",
			"store/Heist Control/Language/German.txt" => "raw.githubusercontent.com/calamity-inc/Stand-Heist-Control/bd267c672b08bfdd940868c270e76f8e3ad66a4b/store/Heist Control/Language/German.txt",
			"store/Heist Control/Language/Italian.txt" => "raw.githubusercontent.com/calamity-inc/Stand-Heist-Control/bd267c672b08bfdd940868c270e76f8e3ad66a4b/store/Heist Control/Language/Italian.txt",
			"store/Heist Control/Language/Japanese.txt" => "raw.githubusercontent.com/calamity-inc/Stand-Heist-Control/bd267c672b08bfdd940868c270e76f8e3ad66a4b/store/Heist Control/Language/Japanese.txt",
			"store/Heist Control/Language/Korean.txt" => "raw.githubusercontent.com/calamity-inc/Stand-Heist-Control/bd267c672b08bfdd940868c270e76f8e3ad66a4b/store/Heist Control/Language/Korean.txt",
			"store/Heist Control/Language/Polish.txt" => "raw.githubusercontent.com/calamity-inc/Stand-Heist-Control/bd267c672b08bfdd940868c270e76f8e3ad66a4b/store/Heist Control/Language/Polish.txt",
			"store/Heist Control/Language/Portuguese.txt" => "raw.githubusercontent.com/calamity-inc/Stand-Heist-Control/bd267c672b08bfdd940868c270e76f8e3ad66a4b/store/Heist Control/Language/Portuguese.txt",
			"store/Heist Control/Language/Russian.txt" => "raw.githubusercontent.com/calamity-inc/Stand-Heist-Control/bd267c672b08bfdd940868c270e76f8e3ad66a4b/store/Heist Control/Language/Russian.txt",
			"store/Heist Control/Language/Spanish.txt" => "raw.githubusercontent.com/calamity-inc/Stand-Heist-Control/bd267c672b08bfdd940868c270e76f8e3ad66a4b/store/Heist Control/Language/Spanish.txt",
			"store/Heist Control/Language/Vietnamese.txt" => "raw.githubusercontent.com/calamity-inc/Stand-Heist-Control/bd267c672b08bfdd940868c270e76f8e3ad66a4b/store/Heist Control/Language/Vietnamese.txt",
		],
		"resources_version" => "r2",
		"resources" => [
			"store/Heist Control/GTAHaXUI/stat.txt" => "raw.githubusercontent.com/calamity-inc/Stand-Heist-Control/083377ea7fd8b508eabfdaa1145243792ae95426/store/Heist Control/GTAHaXUI/stat.txt",
			"store/Heist Control/Image/HC Banner.png" => "raw.githubusercontent.com/calamity-inc/Stand-Heist-Control/083377ea7fd8b508eabfdaa1145243792ae95426/store/Heist Control/Image/HC Banner.png",
			"store/Heist Control/Image/Logo.ytd" => "raw.githubusercontent.com/calamity-inc/Stand-Heist-Control/083377ea7fd8b508eabfdaa1145243792ae95426/store/Heist Control/Image/Logo.ytd",
		],
	],
	"lua/JinxScript" => [
		"priority" => PRIORITY_BLOATWARE,
		...
		"version" => "0.52.3",
		"files" => [
			"JinxScript.pluto" => "raw.githubusercontent.com/awaseru/JinxScript/b2106e174c1baab1656aacdd0387c425ea477406/JinxScript.pluto",
		],
	],
	"lua/AcjokerScript" => [
		"priority" => PRIORITY_BLOATWARE,
	...
	"lua_compat_layer/2Take1Menu" => [
		...
		"version" => "41be898",
		"files" => [
			"lib/2take1 compat.pluto" => "raw.githubusercontent.com/calamity-inc/2take1_lua_loader/41be898455c57105580ba90c4d879e9e46d88c34/lib/2take1 compat.lua",
		]
	],
	"lua/Ji9sw - Gun Van" => [
		"priority" => PRIORITY_USEFUL_UNPOPULAR,
